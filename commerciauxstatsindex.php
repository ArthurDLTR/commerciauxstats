...
/**
 *	\file       commerciauxstats/commerciauxstatsindex.php
 *	\ingroup    commerciauxstats
 *	\brief      Home page of commerciauxstats top menu
 */
...
require_once './class/commerciauxstats.class.php';
...
$langs->loadLangs(array("commerciauxstats@commerciauxstats", "bills", "orders", "companies", "other"));
...
llxHeader("", $langs->trans("CommerciauxStatsArea"), '', '', 0, 0, '', '', '', 'mod-commerciauxstats page-index');
$picto = 'order';
$title = $langs->trans("CommerciauxStatsArea");
...
$stats = new CommerciauxStats($db, $socid, ($userid > 0 ? $userid : 0), ($typent_id > 0 ? $typent_id : 0), ($categ_id > 0 ? $categ_id : 0));
if ($mode == 'customer') {
...
if ($mode == 'customer') {
	$liststatus = array('0'=>$langs->trans("OrderStatusDraft"), '1'=>$langs->trans("OrderStatusNotPaid"), '2'=>$langs->trans("OrderStatusPaid"), '1,2'=>$langs->trans("BillStatusNotPaid").' / '.$langs->trans("BillStatusPaid"), '3'=>$langs->trans("BillStatusCanceled"));
	print $form->selectarray('object_status', $liststatus, $object_status, 1);
}
if ($mode == 'supplier') {
	$liststatus = array('0'=>$langs->trans("OrderStatusDraft"), '1'=>$langs->trans("OrderStatusNotPaid"), '2'=>$langs->trans("OrderStatusPaid"));
	print $form->selectarray('object_status', $liststatus, $object_status, 1);
}
print '</td></tr>';
...
print '<td class="right">'.$langs->trans("NumberOfOrders").'</td>';
